...
export class SpotifyService {
  ...
  constructor(private_http:Http) { 
    this._http = private_http;

  }

  searchMusic(str:string,type='artist'){
    //this.searchUrl = 'https://api.spotify/v1/search?query='+str+'&offset=0&limit=20&type='+type+'&market=US';
    this.searchUrl = 'https://api.spotify.com/v1/search?type=artist&q='+str;
